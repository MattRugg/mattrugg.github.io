    ...
    fetch(fragId)
        ...
        .then(shaderSource => {
            ...
            function resize() {
                ...
                // Lower the render resolution for performance
                const scale = 1; // 40% of display size (adjust as needed)
                canvas.width = Math.round(div.clientWidth * dpr * scale);
                canvas.height = Math.round(div.clientHeight * dpr * scale);
